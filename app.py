...
COURSE_OPTIONS = [
    {
        ...
        "dias_aula": "Sábado | 09h30",
        "horario": "Sábado | 09h30",
    ...
    <style>
        ...
        * {
        ...
        .wizard-fill {
            height: 100%;
            width: 25%;
            background: linear-gradient(90deg, #b42a47 0%, #ff8f84 100%);
            border-radius: 999px;
        ...
        .timeline-card {
            padding: 14px 10px;
            background: linear-gradient(180deg, #b42a47 0%, #ff8f84 100%);
            color: #fff;
        }
                        ...
                        <div class="hero-card">
                            ...
                            <div class="hero-highlights">
                                <div class="hero-highlight">
                                        <strong>RITIMOS</strong>
                                        SAMBA NO PÉ
                                </div>
                                <div class="hero-highlight">
                                    <strong>INFORMAÇÕES</strong>
                                        📅28/03 ÀS 09h30, SÁBADO<br>
                                        📣EVENTO GRATUITO<br>
                                        🕺AULÃO DE RITIMOS
                                </div>
                                <div class="hero-highlight">
                                        <strong>AVISOS IMPORTANTES</strong>
                                        ⚠️EM CASO DE CHUVA SERÁ CANCELADO<br>
                ...
                <section class="wizard-panel" data-step="revisao">
                    <div class="step-card">
                        ...
                        <div class="review-layout">
                            ...
                            <div class="review-box">
                                <div class="review-title">Informações do evento</div>
                                <div class="review-list">
                                    ...
                                    <div class="review-item"><strong>Local</strong><span data-review="endereco_curso"></span></div>
                                </div>
                            </div>
...
<head>
    ...
    <style>
        ...
        .main-header {
            border-bottom: 4px solid #b42a47;
            background: rgba(255, 255, 255, 0.92);
        }
